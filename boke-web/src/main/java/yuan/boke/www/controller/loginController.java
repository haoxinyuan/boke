package yuan.boke.www.controller;
...
import yuan.boke.www.common.Constants;
import yuan.boke.www.common.MD5Util;
import yuan.boke.www.common.RandStringUtils;
...
public class loginController extends BaseController {
    ...
    public String doLogin(Model model, @RequestParam(value = "username",required = false) String email,
        ...
        if (StringUtils.isNotBlank(telephone)){
            //手机登录
            String yzm = redisTemplate.opsForValue().get(telephone);//从redis获取数据
