...
public class SendEmail {
    ...
    public static void sendEmailMessage(String email, String validateCode) {
        try {
            ...
            String from = "phone15717916682@163.com";    //发邮件的出发地（发件人的信箱）
            ...
            MyAuthenticator myauth = new MyAuthenticator(from, "qq111111");
...
//    session.setDebug(true);
            ...
            // Set the content
            message.setContent("<a href=\"http://localhost:8087/bokeweb/activecode?email=" + email + "&validateCode=" + validateCode + "\" target=\"_blank\">请于24小时内点击激活</a>", "text/html;charset=gb2312");
            message.saveChanges();
